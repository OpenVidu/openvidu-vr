...
function initLights() {
    ambient = new THREE.AmbientLight(0x9b9b9b);
    scene.add(ambient);
...
function initGeometry() {
    floorTexture = new THREE.ImageUtils.loadTexture('resources/textures/tile.jpg');
    floorTexture.wrapS = floorTexture.wrapT = THREE.RepeatWrapping;
    floorTexture.repeat.set(50, 50);
    floorTexture.anisotropy = 32;

    var floorMaterial = new THREE.MeshBasicMaterial({ map: floorTexture, transparent: true, opacity: 0.8 });
    ...
    // add some boxes.
    var boxTexture = new THREE.ImageUtils.loadTexture('resources/textures/blue_blue.jpg');
    ...
    var coreTexture = new THREE.ImageUtils.loadTexture('resources/textures/purple_blue.jpg');
    for (var i = 0; i < 50; i++) {
